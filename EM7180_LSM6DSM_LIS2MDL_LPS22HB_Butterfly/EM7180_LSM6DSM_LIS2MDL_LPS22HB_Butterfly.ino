...
void loop() {
  ...
  if(alarmFlag) { // update RTC output (serial display) whenever the RTC alarm condition is achieved and the MPU9250 is awake
    ...
    if(!passThru)
    {
      ...
      if (SerialCptOutput) {
        Serial.write((int)1000 * Ax);
        Serial.write((int)1000 * Ay);
        Serial.write((int)1000 * Az);// Serial.println(" mg");
        Serial.write( Gx, 2);
        Serial.write( Gy, 2);
        Serial.write( Gz, 2);// Serial.println(" deg/s");
        Serial.write( (int)Mx);
        Serial.write( (int)My);
        Serial.write( (int)Mz);// Serial.println(" mG");
        ...
        /*Serial.print("Hardware Grav_x, Grav_y, Grav_z: ");*/
        Serial.write(-A31 * 1000);
        Serial.write(-A32 * 1000);
        Serial.write(A33 * 1000);  //Serial.println(" mg");
        /*Serial.print("Hardware Lin_ax, Lin_ay, Lin_az: ");*/
        Serial.write(lin_Ax * 1000);
        Serial.write(lin_Ay * 1000);
        Serial.write(lin_Az * 1000);  //Serial.println(" mg");
        ...
        /*Serial.println(" C"); // temperature in degrees Celsius*/
        /*Serial.print("Altimeter temperature = ");*/
        /*Serial.write(9.0f * Temperature / 5.0f + 32.0f);*/
        /*Serial.println(" F"); // temperature in degrees Fahrenheit*/
        /*Serial.print("Altimeter pressure = ");*/
