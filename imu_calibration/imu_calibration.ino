...
void setup()
{
  delay(22000); // The stupid ass boot up time for the serial on my pc
  Serial.begin(115200);
  Serial.clear();
  ...
  if(!passThru)
  {
    ...
    {
      serial_input = Serial.read();
      Serial.print("Recieved invalid input: ");
...
{  
  ...
  { 
    ...
    if(SerialDebug)
    {
      Serial.print("Accel:"); Serial.print((int)1000*ax);  
      Serial.print(", "); Serial.print((int)1000*ay); 
      Serial.print(", "); Serial.print((int)1000*az); Serial.println(" mg");
      Serial.print("Gyro:"); Serial.print( gx, 2); 
      Serial.print(", "); Serial.print( gy, 2); 
      Serial.print(", "); Serial.print( gz, 2); Serial.println(" deg/s");
      Serial.print("Mag:"); Serial.print( (int)mx); 
